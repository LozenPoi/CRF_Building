...
if __name__ == '__main__':
    ...
    with open("sod_phrase_acc_partial_entropy_sum_edit_z.bin", "wb") as phrase_confidence_file:
        pickle.dump(phrase_acc, phrase_confidence_file)
    with open("sod_out_acc_partial_entropy_sum_edit_z.bin", "wb") as out_confidence_file:
        pickle.dump(out_acc, out_confidence_file)
    with open("sod_partial_entropy_sum_edit_num_z.bin", "wb") as label_count_file:
        pickle.dump(label_count, label_count_file)
    with open("sod_partial_entropy_sum_edit_pseudo_acc_z.bin", "wb") as pseudo_acc_file:
